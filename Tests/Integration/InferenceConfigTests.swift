...
final class InferenceConfigTests: XCTestCase {
    ...
    func testMantleRegionAvailability() {
        XCTAssertNil(Backend.mantleRegions(for: "openai.gpt-5.6-sol"))
        XCTAssertNil(Backend.mantleRegions(for: "openai.gpt-5.6-terra"))
        XCTAssertNil(Backend.mantleRegions(for: "openai.gpt-5.6-luna"))
        XCTAssertNil(Backend.mantleRegions(for: "openai.gpt-6-astra"))
