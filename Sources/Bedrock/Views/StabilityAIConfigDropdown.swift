                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ForEach(StabilityAITaskType.allCases) { taskType in
                        ...
                        ImageTaskTypeRow(
                            ...
                            accentColor: WorkbenchStyle.accent,
                    ...
                    WorkbenchMenuField(title: "Style preset", selection: $stylePreset,
                                       options: StabilityAIStylePreset.allCases.map { ($0, $0.displayName) })
                    .padding(.horizontal, 12)
                    .padding(.bottom, 8)
