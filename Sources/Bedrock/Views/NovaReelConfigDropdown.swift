        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    .padding(.horizontal, 12)
                    .padding(.vertical, 10)
                    .background(WorkbenchStyle.accent.opacity(0.1))
                    .cornerRadius(8)
                    .padding(.horizontal, 12)
                    .padding(.top, 12)
                    ...
                    if selectedTaskType != .textToVideo {
                        ...
                        WorkbenchMenuField(title: "Video duration", selection: $durationSeconds,
                            options: NovaReelService.durationOptions.filter { $0.seconds >= 12 }.map { ($0.seconds, $0.label) })
                        .padding(.horizontal, 12)
                        .padding(.bottom, 4)
