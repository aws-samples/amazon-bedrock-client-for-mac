...
struct WorkbenchMarkdown: View {
    ...
    var body: some View {
        WorkbenchSelectableMarkdown(rows: document.blocks.map(\.content.row), fontSize: fontSize, highlights: highlights,
...
@MainActor
final class WorkbenchCodeHighlight {
    static let shared = WorkbenchCodeHighlight()
