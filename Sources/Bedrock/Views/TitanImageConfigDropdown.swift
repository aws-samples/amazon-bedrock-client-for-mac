        ...
        Button(action: {
            ...
            HStack(spacing: 8) {
                Image(systemName: selectedTaskType.icon)
                    .font(.system(size: 14))
                    .foregroundColor(WorkbenchStyle.accent)
            ...
            .modifier(ImageConfigDropdownModifier(isHovering: isHovering, colorScheme: colorScheme, accentColor: WorkbenchStyle.accent))
        }
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        HStack {
                            ...
                            Spacer()
                            WorkbenchSegmentedControl(title: "Quality", selection: $quality,
                                                      options: [("standard", "Standard"), ("premium", "Premium")])
                            .frame(width: 160)
                        ...
                        HStack {
                            ...
                            Button(action: { seed = 0; saveConfig() }) {
                                Image(systemName: "dice")
                                    .font(.system(size: 12))
                                    .foregroundColor(seed == 0 ? WorkbenchStyle.accent : .secondary)
                            }
                            .buttonStyle(.plain)
                            .help("0 = Random seed")
                        }
    ...
    var body: some View {
        HStack(spacing: 10) {
            Image(systemName: taskType.icon)
                .font(.system(size: 16))
                .foregroundColor(isSelected ? WorkbenchStyle.accent : .secondary)
                .frame(width: 32, height: 32)
                .background(
                    RoundedRectangle(cornerRadius: 6)
                        .fill(isSelected ? WorkbenchStyle.accent.opacity(0.15) : Color.gray.opacity(0.1))
                )
            ...
            if taskType.requiresInputImage {
                Image(systemName: "photo.badge.plus")
                    .font(.system(size: 11))
                    .foregroundColor(WorkbenchStyle.accent.opacity(0.7))
            }
        }
        .padding(.horizontal, 12)
        .padding(.vertical, 8)
        .background(
            RoundedRectangle(cornerRadius: 6)
                .fill(isSelected ?
                      WorkbenchStyle.accent.opacity(colorScheme == .dark ? 0.15 : 0.08) :
            ...
            Text(label)
                ...
                .background(
                    RoundedRectangle(cornerRadius: 4)
                        .fill(isSelected ? WorkbenchStyle.accent.opacity(0.2) : Color.gray.opacity(0.1))
                )
                .foregroundColor(isSelected ? WorkbenchStyle.accent : .secondary)
        }
        .buttonStyle(.plain)
            ...
            content
                .background(
                    RoundedRectangle(cornerRadius: 8)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 8)
                                .stroke(isHovering ? WorkbenchStyle.accent.opacity(0.5) : Color.gray.opacity(0.2), lineWidth: 1)
                        )
