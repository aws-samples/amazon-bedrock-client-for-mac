...
// MARK: - Nova Canvas Config Dropdown (ModelPicker style)
struct NovaCanvasSettings: View {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    if selectedTaskType == .textToImage {
                        ...
                        SelectionField(title: "Style", selection: $selectedStyle,
                                           options: NovaCanvasStyle.allCases.map { ($0, $0.displayName) })
                        .padding(.horizontal, 12)
                        .padding(.bottom, 8)
