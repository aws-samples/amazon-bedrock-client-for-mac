...
struct TitanImageSettings: View {
    ...
    var body: some View {
        Button(action: {
            ...
            .modifier(ImageConfigDropdownModifier(isHovering: isHovering, colorScheme: colorScheme, accentColor: DesignTokens.accent))
        }
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        HStack {
                            ...
                            Spacer()
                            AppSegmentedControl(title: "Quality", selection: $quality,
                        ...
                        HStack {
                            ...
                            Button(action: { seed = 0; saveConfig() }) {
                                Image(systemName: "dice")
                                    .font(.system(size: 12))
                                    .foregroundColor(seed == 0 ? DesignTokens.accent : .secondary)
                            }
                            .buttonStyle(.plain)
                            .help("0 = Random seed")
                        }
...
struct TitanTaskTypeRow: View {
    ...
    var body: some View {
            ...
            Image(systemName: taskType.icon)
                ...
                .background(
                    RoundedRectangle(cornerRadius: 6)
                        .fill(isSelected ? DesignTokens.accent.opacity(0.15) : Color.gray.opacity(0.1))
                )
        ...
        .background(
            RoundedRectangle(cornerRadius: 6)
                .fill(isSelected ?
                      DesignTokens.accent.opacity(colorScheme == .dark ? 0.15 : 0.08) :
            ...
            Text(label)
                ...
                .background(
                    RoundedRectangle(cornerRadius: 4)
                        .fill(isSelected ? DesignTokens.accent.opacity(0.2) : Color.gray.opacity(0.1))
                )
                .foregroundColor(isSelected ? DesignTokens.accent : .secondary)
        }
        .buttonStyle(.plain)
