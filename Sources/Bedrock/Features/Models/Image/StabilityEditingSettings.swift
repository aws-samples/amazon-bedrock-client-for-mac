//
//  StabilityEditingSettings.swift
...
struct StabilityEditingSettings: View {
    ...
    private var currentService: StabilityAIImageService? {
        StabilityAIImageService.matching(modelId)
    }
...
struct StabilityAIServiceSettingsPopover: View {
    ...
    private var serviceSpecificSettings: some View {
        ...
        case .styleGuide:
            VStack(alignment: .leading, spacing: 8) {
                ...
                SelectionField(title: "Aspect ratio", selection: $aspectRatio,
                                   options: StabilityAIAspectRatio.allCases.map { ($0.rawValue, $0.displayName) })
    ...
    private var stylePresetPicker: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            SelectionField(title: "Style preset", selection: $stylePreset,
                options: [("", "None")] + StabilityAIStylePreset.allCases.filter { $0 != .none }.map { ($0.rawValue, $0.displayName) })
