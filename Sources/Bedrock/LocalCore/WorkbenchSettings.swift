...
enum WorkbenchSettingsPane: String, CaseIterable, Identifiable, Sendable {
...
struct WorkbenchSetting: Identifiable, Sendable {
    var id: String
    var pane: WorkbenchSettingsPane
    var title: String
    var detail: String
    var keywords: String
    ...
    static let all: [WorkbenchSetting] = [
