...
//import CryptoKit
//
//// AWSSSOService is an ObservableObject to manage SSO login state and token handling
//class AWSSSOService: ObservableObject {
//    static let shared = AWSSSOService()  // Singleton instance
//
//    private var ssoOIDC: SSOOIDCClient?
//    private var ssoClient: SSOClient?
//    private var logger = Logger(label: "AWSSSOService")
...
//                    throw NSError(domain: "AWSSSOService", code: -1, userInfo: [NSLocalizedDescriptionKey: "SSOOIDC client not initialized"])
//                }
//
...
//            throw NSError(domain: "AWSSSOService", code: -1, userInfo: [NSLocalizedDescriptionKey: "Client ID or Secret is missing"])
//        }
//
...
//            PreferencesStore.shared.isSSOLoggedIn = true
//
...
//            )
//
//            // Store the token information in PreferencesStore
//            PreferencesStore.shared.ssoTokenInfo = ssoTokenInfo
//
...
//        DispatchQueue.main.async {
//            guard var ssoTokenInfo = PreferencesStore.shared.ssoTokenInfo else { return }
...
//            throw NSError(domain: "AWSSSOService", code: -1, userInfo: [NSLocalizedDescriptionKey: "Start URL is missing"])
//        }
...
//            PreferencesStore.shared.isSSOLoggedIn = false
//            PreferencesStore.shared.ssoTokenInfo = nil
//        }
//    }
//
//    // Refresh the token if it's expired
//    func refreshTokenIfNeeded() async throws {
//        guard var ssoTokenInfo = PreferencesStore.shared.ssoTokenInfo else {
//            throw NSError(domain: "AWSSSOService", code: -1, userInfo: [NSLocalizedDescriptionKey: "SSO token info is missing."])
//        }
//
...
//            throw NSError(domain: "AWSSSOService", code: -1, userInfo: [NSLocalizedDescriptionKey: "Access token is missing"])
//        }
//        guard let ssoClient = ssoClient else {
//            throw NSError(domain: "AWSSSOService", code: -1, userInfo: [NSLocalizedDescriptionKey: "SSO client not initialized"])
//        }
//
