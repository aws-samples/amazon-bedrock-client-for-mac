...
class DictationService: ObservableObject {
    ...
    func startTranscription() async {
        ...
        do {
            ...
            let backend = try BedrockService(region: settings.selectedRegion.rawValue, profile: settings.selectedProfile,
            ...
            transcriptionTask = Task { [weak self] in
                ...
                do {
                    guard let stream = output.transcriptResultStream else { throw LocalOperationError.invalid("Transcribe returned no audio transcript stream.") }
