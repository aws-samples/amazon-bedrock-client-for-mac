...
Keep local test results in `artifacts/`; GitHub retains its results as workflow
artifacts. The [CI scenario map](testing.md) describes coverage. Compilation,
executed tests, live AWS access, and signed/notarized distribution are separate
validation stages.
