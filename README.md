...
A native macOS client that brings Amazon Bedrock's AI models directly to your desktop. Access Claude Sonnet 4.5, Opus 4.5, and other foundation models through a clean interface designed for macOS, with system-wide quick access and full AWS integration.
...
Access Claude Sonnet 4.5, Opus 4.5, Haiku 4.5, and other Bedrock models including Llama 4, Mistral, Qwen3, and DeepSeek V3. Multi-modal support for images and documents with prompt caching.
